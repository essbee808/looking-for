...
if User.where(email: "sheena@gmail.com").blank?
    User.create!(email: "sheena@gmail.com", password: "superpassword", name: "SuperAdmin", admin: true)
end

User.create(name: "Hermione Granger", email: "hermione@gmail.com", password: "password")
User.create(name: "Harry Potter", email: "harry@gmail.com", password: "password")
User.create(name: "Ron Weasley", email: "ron@gmail.com", password: "password")
User.create(name: "Dumbledore", email: "dumbledore@gmail.com", password: "password")
...
Program.create(name: "CalABLE Account", website: "https://www.cdss.ca.gov/benefits-services/more-services/calable", 
    ...
    organization: "CalAble", category_id: 1, creator_id: 2)
Program.create(name: "California Adult Education ", website: "https://caladulted.org/Home", 
    ...
    organization: "California Department of Education", category_id: 2, creator_id: 4)
Program.create(name: "Volunteer Opportunities", website: "https://www.volunteermatch.org/", 
    ...
    organization: "Volunteer Match", category_id: 3, creator_id: 4)
Program.create(name: "Housing Choice Voucher Program (Section 8)", website: "https://www.benefits.gov/benefit/710A", 
    ...
    organization: "The Housing Authority of the County of Los Angeles", category_id: 4, creator_id: 2)
Program.create(name: "CalFresh", website: "https://www.cdss.ca.gov/calfresh", 
    ...
    organization: "California Department of Social Services", category_id: 5, creator_id: 5)
Program.create(name: "Find the Right Therapist For You", website: "https://www.therapyden.com/", 
    ...
    organization: "Therapy Den", category_id: 6, creator_id: 2)
Program.create(name: "Meet New People Who Share Your Interests", website: "https://www.meetup.com/", 
    ...
    organization: "Meetup", category_id: 7, creator_id: 5)
Program.create(name: "ACCESS", website: "https://accessla.org/", 
    ...
    organization: "Access Services", category_id: 8, creator_id: 3)
Program.create(name: "Lifeline - Utility Users Tax Exemption for Seniors and Individuals with Disabilities", website: "https://accessla.org/", 
    ...
    organization: "State of California", category_id: 1, creator_id: 3)
Program.create(name: "Scooter Rental", website: "https://scootaround.com/en/mobility-scooter-rentals", 
    ...
    organization: "Scootaround", category_id: 8, creator_id: 3)
Program.create(name: "Free COVID-19 At Home Tests Available!", website: "https://picturegenetics.com/covid19/", 
    ...
    organization: "Fulgent Genetics", category_id: 5, creator_id: 3)
